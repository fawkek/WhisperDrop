...
<p align="center">
  <a href="https://github.com/fawkek/WhisperDrop/releases/download/v0.2.1/WhisperDrop-0.2.1-macOS.zip"><b>↓ Скачать тестовую сборку для macOS</b></a>
  &nbsp;·&nbsp;
  <a href="https://github.com/fawkek/WhisperDrop/releases/tag/v0.2.1">Все релизы</a>
</p>
...
Скачайте [WhisperDrop 0.2.1 для macOS](https://github.com/fawkek/WhisperDrop/releases/download/v0.2.1/WhisperDrop-0.2.1-macOS.zip), распакуйте ZIP и перенесите `WhisperDrop.app` в папку «Программы». Это тестовая сборка без Apple Developer ID и notarization, поэтому macOS может показать предупреждение при первом открытии. Модель распознавания не входит в архив: приложение предложит скачать её при первом запуске
